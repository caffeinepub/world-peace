        ...
        <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-xl overflow-hidden flex flex-col md:flex-row items-center gap-8 p-8 md:p-10">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-base md:text-lg">
              Srishty is a 16-year-old student and the creator of this Global
              Peace website. She believes that young people can play an
              ...
              Srishty describes herself as a multitalented and multitasking
              individual who enjoys working on meaningful projects that inspire
              positivity, unity, and global understanding.
            </p>
